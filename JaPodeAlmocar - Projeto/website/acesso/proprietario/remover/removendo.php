...
<head>
  ...
  <title>REMOÇÃO DE GERENTE | PROPRIETÁRIO</title>
...
<body>
  ...
  <main>
    <form action="validar_remover.php" method="post" class="form">
      <h2>Remoção de gerente</h2>
      <div class="painel">
        <div class="mensagem">Deseja remover?</div>
        <div class="infos">
          <div class="info">
            <div class="info-t">Nome:</div>
            <div class="info-d"><?php echo $row['nome_gerente']?></div>
          </div>
          <div class="info">
            <div class="info-t">E-mail:</div>
            <div class="info-d"><?php echo $row['email_gerente']?></div>
          </div>
          <div class="info">
            <div class="info-t">Data de nascimento:</div>
            <div class="info-d"><?php echo $row['dataNascimento_gerente']?></div>
          </div>
          <div class="info">
            <div class="info-t">Sexo:</div>
            <div class="info-d"><?php echo $row['sexo_gerente']?></div>
          </div>
        </div>
      </div>
